...
Use an equivalent Bayesian model specified in JAGS to answer this research question. 

1. Write out your statistical model and priors.
2. Assume that your ROPE is 1/4 inch. Print statistical output, create a data visualization, **AND** summarize your results in writing.
